...
<body>
	...
	<footer id="footer"><!--Footer-->
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							<h2><span>Flower</span>-shopper</h2>
							<p>Hoa tươi tới mọi nhà</p>
						</div>
					</div>
					<div class="col-sm-7">
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Đồ án cuối kỳ</p>
					<p class="pull-right">Designed <span><a target="_blank" href="http://www.themeum.com"></a></span></p>
				</div>
			</div>
		</div>
